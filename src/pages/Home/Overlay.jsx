    ...
    <div className='row'>
      <div className='col-md'>
        <h1 className='display-1 fw-bold text-primary'>
          <span className='text-secondary'>Find</span> Job<span className='text-secondary'>.</span>
        </h1>
        ...
        <form className='p-3 my-5 d-flex justify-align-items-center align-items-centerrounded-2 shadow rounded-2'>
          <div className='input-group'>
            ...
            <input type='search' className='form-control border-0 shadow-none' placeholder='Search for job title' aria-label='job title' />
            <span className='input-group-text border-0 bg-transparent'>
              <i className='bi bi-geo-alt align-self-center text-muted' />
            </span>
            <input type='search' className='form-control border-0 shadow-none' placeholder='Search for city' aria-label='city' />
