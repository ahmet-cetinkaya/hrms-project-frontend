    ...
    <div className='col-md-5 px-4'>
      <div className='job-item p-4 border rounded-2  shadow'>
          ...
          <div className='d-flex align-items-center'>
            ...
            <span>
              ...
              <div className='text-primary fw-bold'>
                Open Positions <span className='badge bg-secondary ms-1'>{jobAdvert.numberOfOpenPositions}</span>
              </div>
            </span>
          </div>
        ...
        <div className='d-flex justify-content-between align-items-center mt-3'>
          <div>
            <div className='text-muted m-0'>Posted at {new Date(jobAdvert.createdAt).toDateString()}</div>
            <div className='text-muted'>Deadline at {new Date(jobAdvert.applicationDeadline).toDateString()}</div>
          </div>
